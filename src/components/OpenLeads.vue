  ...
  <div class="mainDiv">
    <div class="leadsDiv">
      <select @change="onchange($event)" class="select-css">
        ...
        <option v-for="l in leadList1" v-bind:key="l.leadId" v-bind:value="l.leadId">{{l.leadName}}</option>
      </select>
    </div>
...
export default {
    ...
    closelead() {
      axios
        .post("http://172.16.20.161:8090/marketingAgent/uploadComments", {
      ...
      axios
        .get(
          "http://172.16.20.161:8090/marketingAgent/closeLead/" +
